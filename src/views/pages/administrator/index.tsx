...
import { deleteadministratorList, getadministratorList, postadministratorList } from 'src/store/slice/administrator';
    ...
    return (
        <Grid>
            <Grid sx={{ p: 2, boxShadow: "4px 4px 8px 8px #ccc", backgroundColor: "#f5f5f5" }}  >
                <Typography variant='h3' color={"blue"}>Administrator</Typography>
            </Grid>
            <Grid>
                <ToolAdministrator />
